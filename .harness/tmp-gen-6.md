...
4. `.harness/sprint-contracts/sprint-6.md` — what to build
5. `.harness/eval-reports/sprint-6.md` — feedback (only if retry)
...
Read eval report. Fix every issue.

## After

```bash
git add -A && git commit -m "sprint 6: implement <description>"
```
